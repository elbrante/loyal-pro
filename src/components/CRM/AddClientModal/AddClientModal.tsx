...
import { Input } from "../../MainStartPage/Input/Input";
                ...
                <div className={cl.formGroup}>
                    <div className={cl.groupInputs}>
                        <div className={cl.inputImg}>
                            ...
                            <Input colorText='CRM' placeholder={'Имя'} state={setFullName} />
                        </div>
                        <div className={cl.inputImg}>
                            <img className={cl.image} src={phone} alt='' />
                            <Input colorText='CRM' placeholder={'Номер телефона'} state={setPhoneNumber} />
                        </div>
                        <div className={cl.inputImg}>
                            <img className={cl.image} src={calendar} alt='' />
                            <Input colorText='CRM' placeholder={'Дата рождения'} state={setBirthday} />
                        </div>
                    </div>
